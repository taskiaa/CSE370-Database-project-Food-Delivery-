...
<div class="container my-5">
    ...
    $sql_query = "SELECT * FROM customer WHERE username='$username' and password='$password'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class="mt-4">
            <a href="./customer-restaurant-list.php" class="btn btn-primary mb-3">See Restaurants</a>
        </div>
        <?php
    } else {
        ?>
